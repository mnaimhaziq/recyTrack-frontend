...
} from "../../redux/Recycling/RecyclingFunction/LocationFunction";
...
const RecyclingLocation = () => {
  ...
  }, [page, search, user.token, dispatch]) 
  ...
  const handleSearchChange = (event) => {
    ...
    const timeout = setTimeout(() => {
      dispatch(
        getAllRecycleLocationByPageAndKeyword({ token: user.token, page, search: value })
      );
    }, 1000);
    ...
    <>
      <Box m="1.5rem 2.5rem " p="0 0 4rem 0">
        ...
        {allRecycleLocations && currentLocation && (
          ...
          >
            <h3 style={{textAlign: 'center'}}>Explore Recycling Locations on the Map</h3>
                  ...
                  >
                    <Popup>
                      ...
                      >
                        ...
                        <a
                          href={`https://waze.com/ul?ll=${recycleLocation.latitude},${recycleLocation.longitude}&navigate=yes&z=10`}
                          target="_blank" rel="noreferrer"
                        >
                          <Button
                            variant="contained"
